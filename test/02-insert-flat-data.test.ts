...
const insertMovies = (movies: Movie[]) => {
  return (
    ...
    movies.map(movie => `('${escape(movie.imdbId)}', '${escape(movie.popularity.toString())}',
    '${escape(movie.budget.toString())}', '${escape(movie.revenue.toString())}',
    '${escape(movie.originalTitle)}', '${escape(movie.homepage)}', '${escape(movie.tagline)}', '${escape(movie.overview)}',
    '${escape(movie.runtime.toString())}', '${escape(movie.releaseDate)}','${escape(movie.budgetAdjusted.toString())}',
